...
public class MainController extends HttpServlet {
    ...
    private static final String SEEALL= "SEE ALL";
    private static final String SEEALL_CONTROLLER= "SeeAllController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            }else if(SEEALL.equals(action)){
                url= SEEALL_CONTROLLER;
